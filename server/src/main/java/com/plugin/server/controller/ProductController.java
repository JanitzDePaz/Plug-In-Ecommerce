...
public class ProductController {
        ...
        productList.add(new Product(
            ...
            new ArrayList<>(Arrays.asList(
                ...
                "/products/keyboards/huntsman-v3-pro/keyboard-base.png",
                "/products/keyboards/huntsman-v3-pro/fast-settings.png",
                "/products/keyboards/huntsman-v3-pro/keys.png",
                "/products/keyboards/huntsman-v3-pro/dial.png")),
            25,
            "Razer",
            5,
