...
export const HeadsetSection = () => {
  const {
    setColorAquamarineContour: changeColorAquamarineContour,
    setColorPurpleContour: changeColorPurpleContour,
    setColorWhiteContour: changeColorWhiteContour,
    setColorBlackContour: changeColorBlackContour,
    setColorWhitePads: changeColorWhitePads,
    setColorBlackPads: changeColorBlackPads,
    setColorGrayPads: changeColorGrayPads,
    setColorBrownPads: changeColorBrownPads,
  } = headsetColorControl();
      ...
      <div className="flex justify-center gap-[10vw] flex-col lg:flex-row py-10">
        ...
        <div className="w-full p-10 lg:p-0 lg:w-[40vw] xl:w-[25vw] flex-center flex-col gap-10">
          ...
          <p className="landingParagraph slideAnimation">
            ...
            potentes y los agudos definidos te hacen sentir la música tal y como
            fue creada. No escuchas, vives la experiencia.
          </p>
          <div className="flex-center flex-col gap-5">
            <Link to={"/tienda"}>
              <button className="landingSecondaryButton slideAnimation">
                Leer más
              </button>
            </Link>
